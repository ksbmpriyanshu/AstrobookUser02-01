...
export const get_testimonial_customer = 'customers/get-testimonial-customer'
...
export const puja_booked_history = 'ecommerce/get_customer_booked_puja';
export const my_order_astrologer = 'customers/recent-chat';
